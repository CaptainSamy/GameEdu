var PuzzlePiece = function(game, x, y, j, i, width, height, pic, sides) {
  ...
  if (this.left_side === 0) {
    ...
    this.piecebmd.ctx.lineTo(Math.floor(tl.x+width*0.09),Math.floor(tl.y+height/3));
    this.piecebmd.ctx.lineTo(Math.floor(tl.x+width*0.15),Math.floor(tl.y+height/3+height/6));
    this.piecebmd.ctx.lineTo(Math.floor(tl.x+width*0.09),Math.floor(tl.y+height/3+2*height/6));
  ...
  if (this.right_side === 0) {
    ...
    this.piecebmd.ctx.lineTo(Math.floor(br.x-width*0.09),Math.floor(br.y-height/3));
    this.piecebmd.ctx.lineTo(Math.floor(br.x-width*0.15),Math.floor(br.y-height/3-height/6));
    this.piecebmd.ctx.lineTo(Math.floor(br.x-width*0.09),Math.floor(br.y-height/3-2*height/6));
  ...
  var src_image = this.game.add.image(config.GAME_WIDTH/2, config.GAME_HEIGHT/2, pic);
